...
/**
 * Servlet per visualizzare l'homepage
 * 
 * @author Luca
 * @since 1.0
 */
...
public class VisualizzaHomepage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Integer[] lista = new Integer[] { 7345, 856, 62, 110415, 254320, 157336, 1359, 680, 808, 489, 429, 652, 4133,
				629, 181808, 429189, 68718, 278, 11778, 313369, 389, 18785, 161, 1402, 393, 111, 103, 83542, 603,
				293660, 4176, 1116, 55931, 274 };
