...
public class RecensioneDAO {
	private static final String GET_RECENSIONI_BY_UTENTE = "SELECT * FROM `recensioni` WHERE `usernameUtente`=?";
	private static final String GET_RECENSIONI_BY_FILM = "SELECT * FROM `recensioni` WHERE `idFilm`=?";
	private static final String GET_RECENSIONE_BY_FILM_AND_UTENTE = "SELECT * FROM `recensioni` WHERE `idFilm`=? AND `usernameUtente`=?";
	private static final String INSERT_RECENSIONE = "INSERT INTO `recensioni` (`idFilm`, `usernameUtente`, `voto_recensione`, `testo_recensione`, `titolo_recensione`) VALUES (?, ?, ?, ?, ?);";
	...
	public static ArrayList<Recensione> getRecensioni(Utente u) throws SQLException {
		...
		PreparedStatement pst = con.prepareStatement(GET_RECENSIONI_BY_UTENTE);
	...
	public static ArrayList<Recensione> getRecensioni(Film f) throws SQLException {
		Connection con = DBConnection.ottieniConnessione();
		PreparedStatement pst = con.prepareStatement(GET_RECENSIONI_BY_FILM);
	...
	public static Recensione inserisciRecensione(Recensione r) throws SQLException {
		Connection con = DBConnection.ottieniConnessione();
		PreparedStatement pst = con.prepareStatement(INSERT_RECENSIONE);
